...
public:
    ...
    HashMap(HashFunction hasher); // DONE
    ...
    // Taken from Alex Thornton's Single Dimension Array Notes
...
private:
    ...
    unsigned int get_index(int hash) const;
    void recursive_hash(Node *n);
    void recursive_add(Node *n);
